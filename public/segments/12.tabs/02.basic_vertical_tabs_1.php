...
<div handle="true" role="tab-container" class="tab-container">
	<div class="tab-button-container">
		<div editable="true" class="tab-button tab-active" active-class="tab-active" role="tab" activates="pane1" active="true">
			Home
		</div>
		<div editable="true" class="tab-button" active-class="tab-active" role="tab" activates="pane2" active="false">
			Code
		</div>
		<div editable="true" class="tab-button" active-class="tab-active" role="tab" activates="pane3" active="false">
			About
		</div>

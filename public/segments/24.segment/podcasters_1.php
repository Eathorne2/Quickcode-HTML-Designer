...
<section handle="true" class="section" >
	<h1 editable="true" class="title title-color" >
		Featured Podcasters
	</h1>
	<div handle="true" class="user-card" >
		<img class="user-card-img" src="images/segment_images/people/beautiful-sincere-happy-girl-smiling-laughing_176420-9693.jpg" >
		<div editable="true" class="user-card-name" >
			Jean Smith
		</div>
		<div editable="true" class="user-card-info" >
		...
		<div class="user-card-socials" >
			<i class="bi bi-twitter icon" >
			</i>
			<i class="bi bi-instagram icon" >
			</i>
			<i class="bi bi-facebook icon" >
			</i>
		</div>
	</div>
	<div handle="true" class="user-card" >
	...
	<div handle="true" class="user-card" >
		<img class="user-card-img" src="images/segment_images/people/curly-man-with-broad-smile-shows-perfect-teeth-being-amused-by-interesting-talk-has-bushy-curly-dark-hair-stands-indoor-against-white-blank-wall_273609-17092.jpg" >
		<div editable="true" class="user-card-name" >
			John Smith
		</div>
		<div editable="true" class="user-card-info" >
